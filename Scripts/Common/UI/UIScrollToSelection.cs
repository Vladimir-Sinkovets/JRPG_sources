...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIScrollToSelection : MonoBehaviour
    {
        ...
        private void UpdateVerticalScrollPosition(RectTransform selection)
        {
            ...
            var normalizedPosition = TargetScrollRect.verticalNormalizedPosition + (offlimitsValue / LayoutListGroup.rect.height);
            ...
            TargetScrollRect.verticalNormalizedPosition =
                Mathf.SmoothStep(TargetScrollRect.verticalNormalizedPosition, normalizedPosition, Time.unscaledDeltaTime * scrollSpeed);
        }
